...
import * as Home from "./user_page.js";
import * as Util from "./util.js";
import * as FirebaseController from "../controller/firebase_controller.js";
import * as Constant from "../model/constant.js";

export function addEventListeners() {
  Element.menuShoppingCart.addEventListener("click", async () => {
    history.pushState(null, null, Routes.routePathnames.USERSHOPPINGCART);
    user_shopping_cart_page();
  });
}

export async function user_shopping_cart_page() {
  if (!Auth.currentUser) {
